      ...
      {isOpen && (
        ...
        >
          <motion.div 
            ...
            className="bg-[#0D1117] border-2 border-[#3F3F46] rounded-3xl w-full max-w-lg p-8 relative max-h-[90vh] overflow-y-auto text-[#FAFAFA] shadow-2xl"
          >
            <motion.button
            ...
            {error && (
              <motion.div 
                ...
                className="mb-6 p-4 rounded-2xl border border-[#DFE104]/40 bg-[#DFE104]/10 flex items-center gap-3 text-[#DFE104] text-xs font-bold uppercase tracking-wide"
              >
            ...
            {success && (
              <motion.div 
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                className="mb-6 p-4 rounded-2xl border border-[#DFE104] bg-[#DFE104] text-black flex items-center gap-3 text-xs font-bold uppercase tracking-wide"
              >
            ...
            <div className="p-6 border border-white/10 rounded-2xl bg-white/5 flex flex-col items-center text-center mb-6">
              ...
              <div className="mt-3 px-6 py-2.5 bg-[#DFE104] text-black text-sm font-bold uppercase tracking-wider rounded-xl shadow-md font-heading">
                AMOUNT DUE: ₹{entryFee}
              </div>
            </div>
